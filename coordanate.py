...
def get_aligned_images():
    ...
    # 保存内参到本地
    with open('/home/yyq/yolov7/intrinsics.json', 'w') as fp:
    ...
    cv2.imwrite(os.path.join("/home/yyq/yolov7/pics", 'test.jpg'), color_image)
    print("Frames{} Captured")

    time.sleep(5)
    x,y = start_find()
    # 返回相机内参、深度参数、彩色图、深度图、齐帧中的depth帧
    return intr, depth_intrin, color_image, depth_image_3d, aligned_depth_frame, x, y
...
y = 240
while True:
    intr, depth_intrin, rgb, depth, aligned_depth_frame, x, y = get_aligned_images()  # 获取对齐的图像与相机内参
